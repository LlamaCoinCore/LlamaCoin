Contributing to Llamacoin Core
============================

The Llamacoin Core project operates an open contributor model where anyone is
...
list or participate in a weekly [Llamacoin Core PR Review Club](https://bitcoincore.reviews/) meeting.

Communication Channels
----------------------

Most communication about Llamacoin Core development happens on IRC, in the
...
The following applies to code changes to the Llamacoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Llamacoin
Network Protocol consensus changes.

Whether a pull request is merged into Llamacoin Core rests with the project merge
...
Patches that change Llamacoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Llamacoin consensus, it must have been
...
The project leader is the release manager for each Llamacoin Core release.
