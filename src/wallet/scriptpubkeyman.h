...
#ifndef LLAMACOIN_WALLET_SCRIPTPUBKEYMAN_H
#define LLAMACOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Llamacoin Core wallet was originally a collection of unrelated private
...
#endif // LLAMACOIN_WALLET_SCRIPTPUBKEYMAN_H
