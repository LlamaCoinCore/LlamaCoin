...
#ifndef LLAMACOIN_WALLET_WALLET_H
#define LLAMACOIN_WALLET_WALLET_H
...
public:
     ...
     * on this llamacoin node, and set to 0 for transactions that were created
...
#endif // LLAMACOIN_WALLET_WALLET_H
