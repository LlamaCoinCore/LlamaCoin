...
#ifndef LLAMACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define LLAMACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // LLAMACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
