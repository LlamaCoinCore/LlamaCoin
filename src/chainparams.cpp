...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.llamacoin.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.llamacoin.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.llamacoinstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.llamacoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.llc.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.llamacoin.sprovoost.nl"); // Sjors Provoost
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.llamacoin.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tllc.petertodd.org");
        vSeeds.emplace_back("seed.testnet.llamacoin.sprovoost.nl");
