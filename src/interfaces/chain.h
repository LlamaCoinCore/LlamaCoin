// Copyright (c) 2018-2020 The Llamacoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef LLAMACOIN_INTERFACES_CHAIN_H
#define LLAMACOIN_INTERFACES_CHAIN_H
...
//! internal workings of the llamacoin node, and not being very convenient to use.
...
//!   asynchronously
//!   (https://github.com/llamacoin/llamacoin/pull/10973#issuecomment-380101269).
//!
//! * The initMessage() and showProgress() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/llamacoin/llamacoin/pull/15288#discussion_r253321096).
//!
...
#endif // LLAMACOIN_INTERFACES_CHAIN_H
