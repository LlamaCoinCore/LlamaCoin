...
#ifndef LLAMACOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define LLAMACOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@llamacoin.
 *
 ...
 *
 * The chacha20-poly1305@llamacoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@llamacoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@llamacoin are relatively fast in
...
#endif // LLAMACOIN_CRYPTO_CHACHA_POLY_AEAD_H
