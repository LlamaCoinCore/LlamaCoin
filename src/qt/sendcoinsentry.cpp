    ...
    platformStyle(_platformStyle)
{
    ...
    // normal llamacoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying llamacoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &LlamacoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
