...
//! Entry point for LlamacoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &LlamacoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for LlamacoinGUI tests.
void AppTests::guiTests(LlamacoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &LlamacoinGUI::consoleShown, this, &AppTests::consoleTests);
