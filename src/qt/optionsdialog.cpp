    ...
    mapper(nullptr)
{
    ...
    ui->llamacoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->llamacoinAtStartup);
    ...
    ui->llamacoinAtStartup->setToolTip(ui->llamacoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->llamacoinAtStartup->setText(ui->llamacoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openLlamacoinConfButton->setToolTip(ui->openLlamacoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new LlamacoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->llamacoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openLlamacoinConfButton_clicked()
{
