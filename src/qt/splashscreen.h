...
#ifndef LLAMACOIN_QT_SPLASHSCREEN_H
#define LLAMACOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Llamacoin Core initialization
...
#endif // LLAMACOIN_QT_SPLASHSCREEN_H
