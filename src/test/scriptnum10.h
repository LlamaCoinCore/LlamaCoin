...
#ifndef LLAMACOIN_TEST_SCRIPTNUM10_H
#define LLAMACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Llamacoin Core 0.10.0, for cross-comparison.
 */
public:
