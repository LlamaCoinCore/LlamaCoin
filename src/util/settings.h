// Copyright (c) 2019-2020 The Llamacoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef LLAMACOIN_UTIL_SETTINGS_H
#define LLAMACOIN_UTIL_SETTINGS_H
...
//!       https://github.com/llamacoin/llamacoin/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored llamacoin settings. This struct combines settings from the command line
...
#endif // LLAMACOIN_UTIL_SETTINGS_H
