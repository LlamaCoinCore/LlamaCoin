// Copyright (c) 2015-2018 The Llamacoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef LLAMACOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
#define LLAMACOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // LLAMACOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
